...
Solid underline = written note. <span class="wikilink
wikilink-broken">Dashed red</span> = planned but not yet written.
...
- [[web-index|Web]] · [[api-index|API]] · [[network-index|Network]]
- [[windows-index|Windows]] · [[linux-index|Linux]] · [[macos-index|macOS]]
...
- [[tools|Tools]] — categorised tool index.
- [[references|References]] — external wikis, labs, books, communities.

---

*Public sources the notes lean on:*
