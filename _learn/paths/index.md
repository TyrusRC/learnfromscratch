...
understand first, what unlocks the next thing, and where to stop being a
learner and start being an operator. Skills aim at real-world
applicability — bug bounty, audit, red team, IR — with CTFs as
training ground.
...
- [[linux-internals]] — privilege model, kernel surface, container
  escape.
...
- [[applied-crypto|Applied cryptography for attackers]] — symmetric,
  asymmetric, RSA breakages, hash-length extension.
